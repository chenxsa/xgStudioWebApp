import { Component, Input, Output,OnInit, EventEmitter, HostListener, HostBinding, ViewEncapsulation } from '@angular/core';
...
import { NoticeItem } from '../../../core/components/components.module';

@Component({
  selector: 'head-notify',
