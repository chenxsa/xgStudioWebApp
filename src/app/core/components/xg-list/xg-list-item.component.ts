...
import { XgListItemActionComponent } from './xg-list-item-action.component';

@Component({
    selector: 'xg-list-item',
    template: `
...
export class XgListItemComponent {

    @HostBinding('class.ant-list-item')
    _nzListItem = true;

    @ContentChildren(XgListItemActionComponent) _actions: QueryList<XgListItemActionComponent>;
